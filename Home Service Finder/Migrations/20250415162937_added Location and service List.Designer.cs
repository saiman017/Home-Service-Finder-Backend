...
namespace Home_Service_Finder.Migrations
{
    ...
    [Migration("20250415162937_added Location and service List")]
    partial class addedLocationandserviceList
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Home_Service_Finder.Locations.Location", b =>
                {
                    b.HasOne("Home_Service_Finder.Users.Users.User", "User")
                        .WithOne("Location")
                        .HasForeignKey("Home_Service_Finder.Locations.Location", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
